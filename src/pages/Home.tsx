...
export default function Home() {
  ...
  return (
    <div className="relative flex h-screen w-screen flex-col items-center justify-center gap-8 overflow-y-auto bg-background px-6 py-10 text-text-primary">
      <div className="flex flex-col items-center gap-1">
        <h1 className="text-4xl font-bold text-accent">Wisp</h1>
        <p className="text-sm text-text-secondary">Voice that doesn&apos;t slow you down</p>
      </div>
      ...
      <div className="w-full max-w-sm rounded-card border border-border bg-surface p-4">
