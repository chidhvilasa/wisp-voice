...
| Platform | Download |
|---|---|
| Windows | [Wisp_0.6.1_x64-setup.exe](https://github.com/chidhvilasa/wisp-voice/releases/download/v0.6.1/Wisp_0.6.1_x64-setup.exe) |
| macOS (Intel + Apple Silicon) | [Wisp_0.6.1_universal.dmg](https://github.com/chidhvilasa/wisp-voice/releases/download/v0.6.1/Wisp_0.6.1_universal.dmg) |
| Linux | [Wisp_0.6.1_amd64.AppImage](https://github.com/chidhvilasa/wisp-voice/releases/download/v0.6.1/Wisp_0.6.1_amd64.AppImage) |
...
Download and run `Wisp_0.6.1_x64-setup.exe`.
...
**One-command install:**
```bash
curl -L https://github.com/chidhvilasa/wisp-voice/releases/download/v0.6.1/Wisp_0.6.1_universal.dmg -o /tmp/Wisp.dmg && hdiutil attach /tmp/Wisp.dmg && sudo cp -r "/Volumes/Wisp/Wisp.app" /Applications/ && sudo xattr -cr /Applications/Wisp.app && hdiutil detach "/Volumes/Wisp" && open /Applications/Wisp.app
```
...
Download `Wisp_0.6.1_amd64.AppImage`, make it executable, and run it:
```bash
chmod +x Wisp_0.6.1_amd64.AppImage
./Wisp_0.6.1_amd64.AppImage
```
